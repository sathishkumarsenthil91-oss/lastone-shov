          ...
          <form onSubmit={handleSignInSubmit} className="p-6 sm:p-8 space-y-5">
            ...
            <div className="pt-3 space-y-3">
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700/80 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-100 font-bold text-xs shadow-sm transition flex items-center justify-center gap-2.5 cursor-pointer disabled:opacity-50"
              >
